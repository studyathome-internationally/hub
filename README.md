...
* [Release](https://github.com/studyathome-internationally/hub/actions/workflows/release.yml): builds and deploys website to https://hub.studyathome.technikum-wien.at/
* [Prerelease](https://github.com/studyathome-internationally/hub/actions/workflows/prerelease.yml): builds and deploys website to https://hub.studyathome.technikum-wien.at/next/
* [Algolia](https://github.com/studyathome-internationally/hub/actions/workflows/algolia.yml): deletes previous, creates and uploads new index to Algolia
